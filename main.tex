...
\begin{frame}{Subsequence Extraction}
	...
	%\only<2>{
%		\begin{tikzpicture}
%			\node[inner sep=0pt] (ts) at (0,-1)
%			{\includegraphics[height=1.2cm]{figures/subsequences_3.pdf}};
%			
%			\node[inner sep=0pt] (ts) at (-3.8,-3)
%			{\includegraphics[height=3.9cm]{figures/subsequences_2.pdf}};	
%		\end{tikzpicture}
%	}
\end{frame}
